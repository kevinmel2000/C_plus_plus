//
//  basic_sequence_container_ops.h
//  STL Containers
//
...
#ifndef STL_Containers_basic_sequence_container_ops_h
#define STL_Containers_basic_sequence_container_ops_h
...
void call_funcs_basic_sequence_container_ops(){
    ...
    //Insert more characters into v and v2.
    //This time, insert them at the end.
    ...
    //Determine if v is less than v2.
    //This is a lexicographical compare.
    //Therefore, the first non-matching element determines which container is less than another.
    if (v < v2) {
